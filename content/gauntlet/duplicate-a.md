...
raw_head = '''
  ...
  <meta name="description" content="Cette page traite du cas de la duplication, illustrant un parcours d'obstacles spécifique pour Noyaru, afin de déclencher la famille des doublons." />
