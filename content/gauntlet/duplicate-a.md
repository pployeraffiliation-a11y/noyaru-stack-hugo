...
title = 'Deux pages avec des titres similaires pour le test de duplication'
html_attrs = ' lang="fr"'
raw_head = '''
  ...
  <title>Deux pages avec des titres similaires pour le test de duplication</title>
  <meta name="description" content="Explorez le parcours d'obstacles Noyaru, une expérience unique qui met en avant des défis captivants à relever." />
  <link rel="canonical" href="https://noyaru-stack-hugo.netlify.app/gauntlet/duplicate-a/" />
  <meta property="og:type" content="article" />
  <meta property="og:title" content="Deux pages avec des titres similaires pour le test de duplication" />
  ...
  <meta name="twitter:title" content="Deux pages avec des titres similaires pour le test de duplication" />
