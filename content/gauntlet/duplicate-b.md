...
title = 'Test de doublon : deux pages avec un titre unique'
html_attrs = ' lang="fr"'
raw_head = '''
  <!-- FAMILLE VISEE : duplicate_titles + duplicate_meta_descriptions — jumelle de duplicate-a. -->
  <meta name="viewport" content="width=device-width" />
  <title>Test de doublon : deux pages avec un titre unique</title>
  ...
  <meta property="og:title" content="Test de doublon : deux pages avec un titre unique" />
  ...
  <meta name="twitter:title" content="Test de doublon : deux pages avec un titre unique" />
