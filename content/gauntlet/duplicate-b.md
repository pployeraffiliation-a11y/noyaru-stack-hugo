...
title = 'Deux pages avec des titres différents pour le test B'
html_attrs = ' lang="fr"'
raw_head = '''
  <!-- FAMILLE VISEE : duplicate_titles + duplicate_meta_descriptions — jumelle de duplicate-a. -->
  <meta name="viewport" content="width=device-width" />
  <title>Deux pages avec des titres différents pour le test B</title>
  ...
  <meta property="og:title" content="Deux pages avec des titres différents pour le test B" />
  ...
  <meta name="twitter:title" content="Deux pages avec des titres différents pour le test B" />
