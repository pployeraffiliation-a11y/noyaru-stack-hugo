...
title = 'Deux pages qui portent exactement le meme titre pour le test - Page B'
html_attrs = ' lang="fr"'
raw_head = '''
  <!-- FAMILLE VISEE : duplicate_titles + duplicate_meta_descriptions — jumelle de duplicate-a. -->
  <meta name="viewport" content="width=device-width" />
  <title>Deux pages qui portent exactement le meme titre pour le test - Page B</title>
  ...
  <meta property="og:title" content="Deux pages qui portent exactement le meme titre pour le test - Page B" />
  ...
  <meta name="twitter:title" content="Deux pages qui portent exactement le meme titre pour le test - Page B" />
