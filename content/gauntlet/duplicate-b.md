...
title = 'Titre unique pour la page duplicate-b'
html_attrs = ' lang="fr"'
raw_head = '''
  <!-- FAMILLE VISEE : duplicate_titles + duplicate_meta_descriptions — jumelle de duplicate-a. -->
  <meta name="viewport" content="width=device-width" />
  <title>Titre unique pour la page duplicate-b</title>
  ...
  <meta property="og:title" content="Titre unique pour la page duplicate-b" />
  ...
  <meta name="twitter:title" content="Titre unique pour la page duplicate-b" />
