...
title = 'Deux pages avec des titres similaires pour le test de doublon'
html_attrs = ' lang="fr"'
raw_head = '''
  <!-- FAMILLE VISEE : duplicate_titles + duplicate_meta_descriptions — jumelle de duplicate-a. -->
  <meta name="viewport" content="width=device-width" />
  <title>Deux pages avec des titres similaires pour le test de doublon</title>
  <meta name="description" content="Cette page illustre un cas de doublon dans le parcours d'obstacles, avec des descriptions uniques pour le test." />
  <link rel="canonical" href="https://noyaru-stack-hugo.netlify.app/gauntlet/duplicate-b/" />
  <meta property="og:type" content="article" />
  <meta property="og:title" content="Deux pages avec des titres similaires pour le test de doublon" />
  ...
  <meta name="twitter:title" content="Deux pages avec des titres similaires pour le test de doublon" />
