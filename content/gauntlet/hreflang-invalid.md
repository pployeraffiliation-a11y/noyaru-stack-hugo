...
title = 'Hreflang Invalid : Erreurs et Solutions Noyaru'
html_attrs = ' lang="fr"'
raw_head = '''
  <!-- FAMILLE VISEE : hreflang_annotation_invalid — code de langue mal forme (soulignement au lieu du tiret). -->
  <meta name="viewport" content="width=device-width" />
  <title>Hreflang Invalid : Erreurs et Solutions Noyaru</title>
  <meta name="description" content="Cette page traite des erreurs hreflang, illustrant un cas spécifique où la famille visée se déclenche au crawl." />
  ...
  <meta property="og:title" content="Hreflang Invalid : Erreurs et Solutions Noyaru" />
  <meta property="og:description" content="Cette page traite des erreurs hreflang, illustrant un cas spécifique où la famille visée se déclenche au crawl." />
  ...
  <meta name="twitter:title" content="Hreflang Invalid : Erreurs et Solutions Noyaru" />
  <meta name="twitter:description" content="Cette page traite des erreurs hreflang, illustrant un cas spécifique où la famille visée se déclenche au crawl." />
