...
title = 'Erreur hreflang : cas d annotation invalide Noyaru'
html_attrs = ' lang="fr"'
raw_head = '''
  <!-- FAMILLE VISEE : hreflang_annotation_invalid — code de langue mal forme (soulignement au lieu du tiret). -->
  <meta name="viewport" content="width=device-width" />
  <title>Erreur hreflang : cas d annotation invalide Noyaru</title>
  <meta name="description" content="Cette page traite des erreurs hreflang, illustrant un cas spécifique pour la famille visée au crawl." />
  ...
  <meta property="og:title" content="Erreur hreflang : cas d annotation invalide Noyaru" />
  <meta property="og:description" content="Cette page traite des erreurs hreflang, illustrant un cas spécifique pour la famille visée au crawl." />
  ...
  <meta name="twitter:title" content="Erreur hreflang : cas d annotation invalide Noyaru" />
  <meta name="twitter:description" content="Cette page traite des erreurs hreflang, illustrant un cas spécifique pour la famille visée au crawl." />
