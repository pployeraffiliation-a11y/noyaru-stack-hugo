...
raw_head = '''
  ...
  <meta name="description" content="Cette page traite du parcours d'obstacles avec un double slash, illustrant un cas spécifique pour la famille visée au crawl." />
  ...
  <meta property="og:image" content="https://noyaru-stack-hugo.netlify.app/og.png" alt="Image de la page de test pour le parcours d'obstacles Noyaru" />
  ...
  <meta name="twitter:image" content="https://noyaru-stack-hugo.netlify.app/og.png" alt="Image de la page de test pour le parcours d'obstacles Noyaru" />
'''
raw_body = '''
